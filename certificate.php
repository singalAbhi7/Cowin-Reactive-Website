...
$sql = "select name, DOB, adhaar,secret_code, vaccination_status from patient_records where number=$number;";
...
<body>
    ...
    <div id="main">
        ...
        <p class="mobile">Registered Mobile Number: <p class="blue_mobile"><?php echo $number?></p></p>
        <div id="info">
            <fieldset>
                <legend class="status" style= "color:black"><?php echo $row['vaccination_status']?></legend>
                <p class="name"><?php echo $row['name'] ?> </p>
                <p class="ref_id">REF ID: 5239959756<p class="red"> 8700 </p></p>
                <p class="secret_code">Secret Code:<?php echo $secret ?> <?php echo $row['secret_code'] ?> </p>
                <p class="yob">DOB:<?php echo $row['DOB'];  ?></p>
                <p class="photo">Photo ID: <p class="photo_value"> Adhaar Card</p></p>
                <p class="idnum">ID Number: <p class="idnum_value"> <?php echo $adhaar ?> <?php echo $row['adhaar'] ?></p></p>
    ...
    <div id="secondary">
        <br>
        <!-- <h3><img src="info1.png" alt="" class="logo">  Note</h3> -->
        <br>
